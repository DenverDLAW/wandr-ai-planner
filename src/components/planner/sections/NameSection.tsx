    ...
    <div className="w-full max-w-2xl mx-auto px-5 sm:px-8 text-center">
      ...
      <div className="relative">
        <input
          ...
          className="w-full text-2xl sm:text-3xl md:text-4xl font-light text-gray-900 placeholder-gray-300
      ...
      {name.trim().length >= 1 && (
        <button
          ...
          className="mt-6 sm:mt-10 inline-flex items-center gap-3 bg-blue-600 text-white font-semibold
